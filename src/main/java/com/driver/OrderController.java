...
public class OrderController {
    ...
    public ResponseEntity<String> addOrder(@RequestBody Order order){
        if(order == null){
            return new ResponseEntity<>("Please provide information", HttpStatus.OK);
        }else {
    ...
    public ResponseEntity<String> addPartner(@PathVariable String partnerId){
        System.out.println("the givem format is : " + partnerId);
...
//        System.out.println("the given order id : " + orderId);

        Order order= orderService.getOrderById(orderId);

//        if(order == null){
//            System.out.println("the fetched data is null");
//        }else{
